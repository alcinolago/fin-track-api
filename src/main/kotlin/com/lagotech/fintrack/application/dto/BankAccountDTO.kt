...
data class BankAccountDTO(
    ...
    @field:NotBlank(message = "O nome do banco não pode estar em branco")
    var bankName: String,

    @field:NotBlank(message = "O número da conta não pode estar em branco")
    ...
    @field:NotBlank(message = "O dígito da conta não pode estar em branco")
    ...
    @field:NotBlank(message = "O código da agência não pode estar em branco")
